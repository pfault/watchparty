...
app.post('/createRoom', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    newRoom.video = ((_d = req.body) === null || _d === void 0 ? void 0 : _d.video) || '';
...
app.post('/manageSub', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _e, _f, _g;
    const decoded = yield firebase_1.validateUserToken((_e = req.body) === null || _e === void 0 ? void 0 : _e.uid, (_f = req.body) === null || _f === void 0 ? void 0 : _f.token);
    if (!decoded) {
    ...
    const session = yield stripe_1.createSelfServicePortal(customer.id, (_g = req.body) === null || _g === void 0 ? void 0 : _g.return_url);
    return res.json(session);
}));
app.get('/metadata', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _h, _j, _k, _l, _m, _o;
    const decoded = yield firebase_1.validateUserToken((_h = req.query) === null || _h === void 0 ? void 0 : _h.uid, (_j = req.query) === null || _j === void 0 ? void 0 : _j.token);
    ...
    if (decoded === null || decoded === void 0 ? void 0 : decoded.email) {
        const customer = yield stripe_1.getCustomerByEmail(decoded.email);
        isSubscriber = Boolean((_l = (_k = customer === null || customer === void 0 ? void 0 : customer.subscriptions) === null || _k === void 0 ? void 0 : _k.data) === null || _l === void 0 ? void 0 : _l.find((sub) => (sub === null || sub === void 0 ? void 0 : sub.status) === 'active'));
        isCustomer = Boolean((_o = (_m = customer === null || customer === void 0 ? void 0 : customer.subscriptions) === null || _m === void 0 ? void 0 : _m.data) === null || _o === void 0 ? void 0 : _o.length);
    }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < roomArr.length; i++) {
            ...
            if (room.vBrowser && room.vBrowser.assignTime) {
                const ttl = yield (redis === null || redis === void 0 ? void 0 : redis.pttl('lock:' + room.vBrowser.provider + ':' + room.vBrowser.id));
...
function getStats() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let currentVBrowserClientCounts = {};
        ...
        currentVBrowserClientCounts = Object.fromEntries(Object.entries(currentVBrowserClientCounts).filter(([, val]) => val > 1));
        // Sort newest first
