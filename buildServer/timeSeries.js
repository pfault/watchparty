        ...
        if (redis) {
            ...
            const ports = process.env.NODE_ENV === 'development'
                ...
                : ecosystem_config_1.default.apps
                    ...
                    .filter((port) => Number(port) === Number(config_1.default.PORT));
            const shardReqs = ports.map((port) => axios_1.default({
            ...
            yield redis.lpush('timeSeries', JSON.stringify({
                time: new Date(),
                availableVBrowsers: (_a = stats.availableVBrowsers) === null || _a === void 0 ? void 0 : _a.length,
                availableVBrowsersLarge: (_b = stats.availableVBrowsersLarge) === null || _b === void 0 ? void 0 : _b.length,
