...
class VMManager {
    constructor(large, region = '') {
        ...
        this.terminateVMWrapper = (id) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.redis.lrem(this.getRedisQueueKey(), 1, id);
            yield this.redis.lrem(this.getRedisStagingKey(), 1, id);
        ...
        this.runBackgroundJobs = () => {
            ...
            const resizeVMGroupIncr = () => __awaiter(this, void 0, void 0, function* () {
                ...
                if (launch) {
                    console.log('[RESIZE-LAUNCH]', 'desired:', vmBufferSize, 'available:', availableCount, 'staging:', stagingCount);
                    this.startVMWrapper();
                }
            });
            ...
            const checkStaging = () => __awaiter(this, void 0, void 0, function* () {
                ...
                while (true) {
                    try {
                            ...
                            new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                                ...
                                if (!host) {
                                    try {
                                        ...
                                        console.log('%s rate limit remaining', e.response.headers['X-Rate-Limit-Remaining']);
                                    ...
                                    if (host) {
                                        ...
                                        yield this.redis.setex(this.getRedisHostCacheKey() + ':' + id, 60, host);
                                    }
                                }
                        ...
                        yield Promise.all(stagingPromises);
                    }
                    catch (e) {
